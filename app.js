document.addEventListener('DOMContentLoaded', function() {
    ...
    function createBoard() {
        startPieces.forEach((startPiece, i) => {
            ...
            //Problema linha 30 e 32. Muito estranho pq se olhar o elemento, a classe square-id está correta. 
            //Outra coisa que não entendo pq uma hora ela usa square e outra square-id
    ...
    function checkIfValid(target){
        ...
        //Nenhum movimento de nenhuma peça funciona pq o tabuleiro ta errado
        switch(piece){
            case 'pawn' :
                const starterRow = [8, 9, 10, 11, 12, 13, 14, 15]
                if(
                    //Pode ser algo aqui na 122, não entendo pq ela não separa as operações
            ...
            case 'bishop' || 'queen' : 
                if(
                    //disgustin. Assim que o código funcionar preciso limpar a sujeira desse tutorial.
                    //uma direção
                    startId + width + 1 === targetId ||
                    startId + width * 2 + 2 === targetId && !document.querySelector(`[square-id="${startId+width+1}"]`).firstChild ||
                    startId + width * 3 + 3 === targetId && !document.querySelector(`[square-id="${startId+width+1}"]`).firstChild && !document.querySelector(`[square-id="${startId+width*2+2}"]`).firstChild && !document.querySelector(`[square-id="${startId+width*3+3}"]`).firstChild ||
